...
##### FROM FILES
kickstarter_dataset_path = "s3://unimib-raw-data-2021/ds_project_details_full.csv"
...
## READ TAGS DATASET
img_dataset_path = "s3://unimib-raw-data-2021/ds_img_details.csv"
...
projects_dataset_agg.write.option("compression", "snappy").mode("overwrite").parquet("s3://unimib-dwh-2021/projects_dataset.out")